...
// Static guide instruction
ifndef::cloud-hosted[]
Before you can deploy your microservice, you must install the Open Liberty Operator. You should read the official installation document on the link:https://github.com/OpenLiberty/open-liberty-operator/tree/main/deploy/releases/0.8.2#readme[GitHub repository].
