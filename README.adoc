...
// Static guide instruction
ifndef::cloud-hosted[]
You need to push your image to a container registry before to deploy it on any cloud environment. Because you are working with local Kubernetes, you can skip this step.
endif::[]
