...
:page-releasedate: 2022-01-31
:page-description: Explore how to deploy a microservice to Kubernetes by using the Open Liberty Kubernetes Operator.
...
:page-seo-title: Deploying a microservice to Kubernetes by using a Kubernetes Operator
...
= Deploying a microservice to Kubernetes by using Kubernetes Operator
...
https://www.kubernetes.io/[Kubernetes^] is a container orchestration system. It streamlines the DevOps
