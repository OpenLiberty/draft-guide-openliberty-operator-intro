...
= Deploying a microservice to Kubernetes by using a Kubernetes Operator
...
// Static guide instruction
ifndef::cloud-hosted[]
Before you can deploy your microservice, you must install the Open Liberty Operator.
...
To check that the Open Liberty Operator has been installed successfully, run the following command:
[role='command']
```
