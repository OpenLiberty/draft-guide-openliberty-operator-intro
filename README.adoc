...
// Static guide instruction
ifndef::cloud-hosted[]
You need to push your image to a container registry prior to deploying it on any cloud environment. You can skip this step because you are working with a local Kubernetes environment.
endif::[]
