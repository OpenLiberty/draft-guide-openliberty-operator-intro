...
If you run Minikube by root user, you can append the `--force` option to the above command.
...
// Static guide instruction
ifndef::cloud-hosted[]
Before you can deploy your microservice, you must install the https://cert-manager.io[cert-manager^] and the Open Liberty Operator. You should read the official installation document on the link:https://github.com/OpenLiberty/open-liberty-operator/tree/main/deploy/releases/1.2.0#readme[GitHub repository].
