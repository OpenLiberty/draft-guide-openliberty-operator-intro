...
During the build process, the `ImageStream` object that you created earlier based on an image from the image registry
was referenced and tagged. Run the following command to view the newly tagged `ImageStream` object:
